...
| 系統 | 入口 | 言語 |
|---|---|---|
| 人間ユーザー向けマニュアル | [`wiki/Home.md`](wiki/Home.md) · [한국어](wiki/Home-ko.md) | EN / KO |
| AI アシスタントガイド | [`wiki/AI-Overview.md`](wiki/AI-Overview.md) · [한국어](wiki/AI-Overview-ko.md) | EN / KO |
...
- **HTMLook Pro** (v1.0) — パワーユーザー向け。BYOM チャット + 内蔵 PTY
  ...
  プロファイル + 49 シード。
- **HTMLook Easier** *(soon)* — はじめての方向けエディション、再定義中。
